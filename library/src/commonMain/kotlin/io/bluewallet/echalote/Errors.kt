...
class DestroyedError(
    val reasonCode: Int,
) : Exception("Circuit destroyed")

class RelayEndedError(
    val reason: RelayEndReason,
) : Exception("Relay ended")

class UnknownAddressType(
    val type: Int,
) : Exception("Unknown address type $type")
...
class UnknownCertExtensionError(
    val type: Int,
) : Exception("Unknown certificate extension $type")
